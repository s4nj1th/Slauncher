...
import app.slauncher.databinding.FragmentAppDrawerBinding
import app.slauncher.helper.hideKeyboard
import app.slauncher.helper.isEinkDisplay
import app.slauncher.helper.isSystemApp
import app.slauncher.helper.openAppInfo
import app.slauncher.helper.openSearch
import app.slauncher.helper.openUrl
import app.slauncher.helper.showKeyboard
import app.slauncher.helper.showToast
import app.slauncher.helper.uninstall
        ...
        binding.search.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                if (query?.startsWith("!") == true) {
                    if (Constants.URL_DUCK_SEARCH.isNotEmpty())
