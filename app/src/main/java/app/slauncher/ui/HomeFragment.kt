...
import app.slauncher.helper.getChangedAppTheme
import app.slauncher.helper.getUserHandleFromString
import app.slauncher.helper.isPackageInstalled
import app.slauncher.helper.openAlarmApp
import app.slauncher.helper.openCalendar
import app.slauncher.helper.openCameraApp
import app.slauncher.helper.openDialerApp
import app.slauncher.helper.openSearch
import app.slauncher.helper.setPlainWallpaperByTheme
import app.slauncher.helper.showToast
import app.slauncher.listener.OnSwipeTouchListener
import app.slauncher.listener.ViewSwipeTouchListener
...
class HomeFragment : Fragment(), View.OnClickListener, View.OnLongClickListener {
    ...
    private fun initObservers() {
        ...
        viewModel.isSlauncherDefault.observe(viewLifecycleOwner, Observer {
            if (it != true) {
