...
import app.slauncher.helper.SingleLiveEvent
import app.slauncher.helper.WallpaperWorker
import app.slauncher.helper.formattedTimeSpent
import app.slauncher.helper.getAppsList
...
import app.slauncher.helper.usageStats.EventLogWrapper
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val isSlauncherDefault = MutableLiveData<Boolean>()
    ...
    fun isSlauncherDefault() {
        isSlauncherDefault.value = isSlauncherDefault(appContext)
    }
